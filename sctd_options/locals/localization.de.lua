...
SCT.LOCALS.OPTION_CHECK112 = { name = "SCTD Zauberfarben", tooltipText = "Aktiviert/Deaktiviert das Anzeigen des Zauberschadens in Farbe der entsprechenden Klasse (Farben einstellbar in SCT)"};
...
SCT.LOCALS.OPTION_MISC107 = {name=" Test ", tooltipText = "Create Test event for each frame"};
