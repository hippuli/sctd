...
SCT.LOCALS.OPTION_CHECK112 = { name = "Окраска заклинаний", tooltipText = "Вкл/Выкл отображение урона заклинаний в цветах классов заклинаний"};
...
SCT.LOCALS.OPTION_MISC107 = {name=" Тест ", tooltipText = "Создаёт тестовое событие для всех фреймов"};
