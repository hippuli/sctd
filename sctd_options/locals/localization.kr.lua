...
SCT.LOCALS.OPTION_CHECK112 = { name = "주문 색상 표시", tooltipText = "주문 피해량을 속성에 따라 색상으로 표시합니다."};
...
SCT.LOCALS.OPTION_MISC107 = {name=" 테스트 ", tooltipText = "각 프레임 설정에 대한 테스트 메시지를 보냅니다."};
